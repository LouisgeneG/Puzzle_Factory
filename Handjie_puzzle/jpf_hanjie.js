...
// Run the init() function when pageloads
window.onload = init;
...
function init(){
  // Insert the title for the first puzzle
   ...
   // Insert the HTML code for fisrt puzzletable
   document.getElementById("puzzle").innerHTML = drawPuzzle(puzzle1Hint, puzzle1Rating, puzzle1);

// Add event handlers for the puzzle button
...
// Add an event listener to the show solution button
    document.getElementById("solve").addEventListener("click", 
      function(){
         //remove the inline backgrounColor style from each cell
...
// Create the swapPuzzle() function
...
if (confirm("You will lose ALL of your work on the puzzle! \n Continue?")) {
       ...
       // Extract the title of the puzzle from the value attribute in the puzzle buttons by adding the command
       var puzzleTitle = e.target.value;
       document.getElementById("puzzleTitle").innerHTML = puzzleTitle;

       // Insert the following switch statement that calls the drawPuzzle() function for each of the three  possible puzzle ID values.
      switch (puzzleID) {
         case "puzzle1":
               document.getElementById("puzzle").innerHTML = drawPuzzle(puzzle1Hint, puzzle1Rating, puzzle1);
               break;
      ...
      // call of the setupPuzzle() function here
        setupPuzzle();
 }
...
// create an object collections of the filled and empty cells
...
//definition the setBackground() function to change the cell backgound  when the user i nteracts with the puzzle
...
// Loop through the puzzleCells array and create an event listener for all of them
  ...
  //Prevent the default action of selecting table text
   ...
   // definition of the extendBackground() function which keeps the 
...
// definition of the endBackground() function which removes all 
//current puzzleCell events
